 ...
 *
 * Uso: MAVEN_BIN=/ruta/a/mvn node scripts/runGeneratedBackendLocally.mjs
 */
...
console.log('== Fase 9+10: generando el backend de ejemplo ==');
...
const outDir = join(process.cwd(), '.local-generated-backend');
...
const dbName = 'sharegrams_manual_test';
...
console.log(`   Ejemplo: GET http://localhost:${port}/api/clientes`);
